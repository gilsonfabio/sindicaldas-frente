...
function CmpCnvVenc() {
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {text: 'PARC', style: 'tableHeader', fontSize: 10},
                        {text: '/', style: 'tableHeader', fontSize: 10},
                        {text: 'PLANO', style: 'tableHeader', fontSize: 10},
                        {text: 'VLR. PARCELA', style: 'tableHeader', fontSize: 10},
                    ],
                    ...dados
                ]
            },
    ...
    function emitePdf() {
        let servidor = 1;
        api.get(`pdfVctCmpCnv/${datInicial}/${datFinal}/${codConvenio}`).then(resp => {
            setVendas(resp.data);  
        })
        ...
        <div>
            ...
            <section className="login">
                <div className="max-width">
                    <h2 className="login-title">Vendas Vencimento</h2>
