...
function CmpEmissao() {
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {text: 'NOME CONVÊNIO', style: 'tableHeader', fontSize: 10},                        
    ...
    function Rodape(currentPage, pageCount){      
        return [  
            {
                columns: [
                    {text: 'Total de Compras.............' + Intl.NumberFormat('pt-BR', {style: 'currency', currency: 'BRL'}).format(totCompras), alignment: 'left', fontSize: 10, margin: [10,0,0,0]},
